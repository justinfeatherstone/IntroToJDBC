...
-- Because I am entering this data from our practice problem relation, I know the IngredientIds. If I didn't have those tables to work from, I'd just do a select on the Ingredient table, so I could
